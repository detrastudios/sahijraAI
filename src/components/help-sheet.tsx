            ...
            <div className="text-center mb-4">
              ...
              <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="item-1">
                  <AccordionTrigger className="text-left">Bagaimana cara menggunakan Sahabat Hijrah AI?</AccordionTrigger>
                  <AccordionContent>
                ...
                <AccordionItem value="item-2">
                  <AccordionTrigger className="text-left">Apakah jawaban AI selalu benar?</AccordionTrigger>
                  <AccordionContent>
                ...
                <AccordionItem value="item-3">
                  <AccordionTrigger className="text-left">Bagaimana cara mengubah tema atau ukuran font?</AccordionTrigger>
                  <AccordionContent>
                 ...
                 <AccordionItem value="item-4">
                  <AccordionTrigger className="text-left">Bagaimana cara menyalin jawaban AI?</AccordionTrigger>
                  <AccordionContent>
                ...
                <AccordionItem value="item-6">
                  <AccordionTrigger className="text-left">Apakah aplikasi ini berbayar?</AccordionTrigger>
                  <AccordionContent>
                ...
                <AccordionItem value="item-5">
                  <AccordionTrigger className="text-left">Bagaimana cara menghubungi Sahijra?</AccordionTrigger>
                  <AccordionContent>
